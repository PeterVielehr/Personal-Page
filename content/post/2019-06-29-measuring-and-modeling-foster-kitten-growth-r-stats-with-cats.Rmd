...
knitr::include_graphics(c("../../img/box_cats1.JPG","../../img/box_cats2.JPG"))
...
Load some packages and data. I was looking for a way to use purrr and Forcats but I didn't need then in such a simple case.
...
kittens.coded<-kittens %>%
  mutate(color=ifelse(Cat=="No Tip", "black", 
                      ifelse(Cat=="Lavender", "violet", tolower(Cat))),
         weight.taken=case_when(Pre_post.eating=="Pre-eating" ~ "Before Eating",
                                Pre_post.eating=="Post-eating" ~ "After Eating"),
         weight.taken=factor(weight.taken, levels = c("Before Eating", "After Eating")),
         sex=case_when(Cat=="Blue" | Cat== "Maroon" ~ "Female",
                       Cat=="Green" | Cat=="Lavender" | Cat=="No Tip" ~ "Male"),
...
![](../../img/kitten trajectories_animation2019-06-28.gif) 
...
![](../../img/kitten_ind_trajectories_animation2019-06-28.gif) 
...
**The Kittens grow 16.5g per day on average!!**
...
```{r, echo=FALSE,out.width="60%", out.height="60%",fig.cap="Blue is Extra Sweet",fig.show='hold',fig.align='center'}
knitr::include_graphics(c("Blue_face.JPG"))
```
